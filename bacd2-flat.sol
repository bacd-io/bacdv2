...
contract BACDV2 is Initializable, ERC20Upgradeable, ERC20SnapshotUpgradeable, AccessControlUpgradeable, PausableUpgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable, FeeControl {
    ...
    function initialize(
        ...
        // create uniswap token pair
        pairToken = baseToken;
        uniswapPair = IUniswapV2Factory(router().factory()).createPair(address(this),pairToken);
    ...
    // Uniswap functions
    function router() public pure virtual returns (IUniswapV2Router02) {
        return IUniswapV2Router02(ROUTER_ADDRESS);
    }
